    ...
    <Grow in timeout={800 + index * 150}>
      <Accordion
        ...
        sx={{
          ...
          "&:hover": {
            boxShadow:
              `0 10px 15px -3px ${alpha(theme.main, 0.1)}, 0 4px 6px -2px ${alpha(theme.main, 0.05)}`,
          },
        }}
      ...
      >
        ...
        <AccordionDetails sx={{ p: 0 }}>
          {expanded && (
            <Box sx={{ width: '100%', opacity: 1, transition: 'opacity 500ms' }}>
              {children}
            </Box>
          )}
        </AccordionDetails>
